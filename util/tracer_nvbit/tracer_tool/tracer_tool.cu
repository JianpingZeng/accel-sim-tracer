...
void nvbit_at_cuda_event(CUcontext ctx, int is_exit, nvbit_api_cuda_t cbid,
  ...
  if (cbid == API_CUDA_cuMemcpyHtoD_v2) {
    ...
    if (is_exit) {
      ...
      char buffer[1024];
      kernelsFile = fopen("./traces/kernelslist", "a");
      sprintf(buffer, "cudaMalloc,0x%016lx,%lld", *(p->dptr), p->bytesize);
      fprintf(kernelsFile, buffer);
      fprintf(kernelsFile, "\n");
      fclose(kernelsFile);
    }
    ...
    if (is_exit) {
      ...
      char buffer[1024];
      kernelsFile = fopen("./traces/kernelslist", "a");
      sprintf(buffer, "cudaHostAlloc,0x%016lx,%lld", *(p->pp), p->bytesize);
      fprintf(kernelsFile, buffer);
      fprintf(kernelsFile, "\n");
      fclose(kernelsFile);
    }
    ...
    if (is_exit) {
      ...
      char buffer[1024];
      kernelsFile = fopen("./traces/kernelslist", "a");
      sprintf(buffer, "cudaFree,0x%016lx", p->dptr);
      fprintf(kernelsFile, buffer);
      fprintf(kernelsFile, "\n");
      fclose(kernelsFile);
    }
    ...
    if (is_exit) {
      ...
      char buffer[1024];
      kernelsFile = fopen("./traces/kernelslist", "a");
      sprintf(buffer, "cudaFreeHost,0x%016lx", p->p);
      fprintf(kernelsFile, buffer);
      fprintf(kernelsFile, "\n");
      fclose(kernelsFile);
    }
    ...
    if (!is_exit) {
      ...
      char buffer[1024];
      kernelsFile = fopen("./traces/kernelslist", "a");
      sprintf(buffer, "cudaMemcpyAsyncHtoD,0x%016lx", p->dstDevice, p->ByteCount);
      fprintf(kernelsFile, buffer);
      fprintf(kernelsFile, "\n");
      fclose(kernelsFile);
    }
